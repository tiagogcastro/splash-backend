...
import PostgresSponsorSponsoredRepository from '@modules/users/infra/typeorm/repositories/PostgresSponsoringSponsoredRepository';

import PostgresUserBalanceRepository from '@modules/users/infra/typeorm/repositories/PostgresUserBalanceRepository';
import PostgresUserSponsorSponsoredCountRepository from '@modules/users/infra/typeorm/repositories/PostgresUserSponsoringSponsoredCountRepository';
